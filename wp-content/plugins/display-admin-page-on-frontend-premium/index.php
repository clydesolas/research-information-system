...
if (!class_exists('VG_Admin_To_Frontend')) {
	...
	class VG_Admin_To_Frontend {
		...
		function get_system_page_ids() {
			...
			$system_page_ids = array_unique(array_map('intval', array_merge($pages_with_wpfa_shortcode, $pages_with_wpfa_meta)));
...
// Hide elements selected on quick-settings
		...
		function cleanup_admin_page_for_frontend() {
			...
			$popup_selectors = '.thickbox-loading .media-modal.wp-core-ui,.media-modal, .showwuSweetAlert, .mfp-content, .am-side-dialog .el-dialog, .mce-window.mce-in, #WUB_window';
